// Ответы на вопросы пакета. Чистая функция поверх уже посчитанного
// результата: уровни осей, находки, уверенность. Модель здесь не
// участвует, веса и пороги не меняются. Тексты вопросов, шаблонов и
// встречных вопросов (ask_seller) лежат в rubric.questions пакета,
// здесь только правила выбора шаблона и подтверждений.
//
...
export function answers(result, rubric, selected) {
    ...
    // Встречные вопросы: сначала от выбранных, потом от остальных,
